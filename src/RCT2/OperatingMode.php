...
enum OperatingMode : int
{
    ...
    case POWERED_LAUNCH_PASSTROUGH = 3; // RCT2 style, passes through station
    case SHUTTLE = 4;
    case BOAT_HIRE = 5;
    ...
    case CONTINUOUS_CIRCUIT_BLOCK_SECTIONED = 34;
    case POWERED_LAUNCH = 35; // RCT1 style, does not pass through station
    case POWERED_LAUNCH_BLOCK_SECTIONED = 36;
}
